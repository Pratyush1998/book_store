                ...
                <div className={classes.successCard}>
                    <Card>
                        <CardContent className={classes.successContent}>
                            <Typography variant="h4" color="textPrimary" style={{ paddingTop: '10%', paddingLeft: '15%' }}>
                                <img
                                    height='50'
                                    width='50'
                                    src={CheckMark}
                            ...
                            <Typography variant="h6" color="textPrimary" style={{ paddingBottom: '10%' }}>
                                We will notify you by email the day your order is ready for pick-up
                            </Typography>
                ...
                <div className={classes.detailsCard}>
                    <Card>
                        <CardContent className={classes.detailContent}>
                            <Typography variant="h6" style={{ textAlign: 'center', paddingBottom: '10%', paddingTop: '5%' }}>
                                Order Details
                            </Typography>
