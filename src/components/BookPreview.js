    ...
    return (
      ...
      >
          ...
          <Container>
            <Row>
              ...
              <Col class="col-md-4 col-lg-4">
                <Row>
                  <button
                    disabled={this.props.cartItems.includes(
                      this.props.props.id
                    )}
                ...
                <Row>
                  ...
                  >
                    Upvote: {this.props.props.upvotes}
                  </button>
                </Row>
                <Row>
                  <button
                  ...
                  >
                    Downvote: {this.props.props.downvotes}
                  </button>
                </Row>
              </Col>
            </Row>
        ...
        <Modal.Footer style={{ backgroundColor: "rgb(122, 0, 60)" }}>
          <Button variant="outline-light" onClick={this.props.onHide}>
            Close
          </Button>
        </Modal.Footer>
      </Modal>
